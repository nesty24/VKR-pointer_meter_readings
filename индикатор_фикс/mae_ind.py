...
# ==========================
GT_FILE = r"C:\Users\79213\PycharmProjects\python\диплом\протестированное\индикатор_фикс\ручная разметка\right_hand.csv"
P15_FILE = r"C:\Users\79213\PycharmProjects\python\диплом\протестированное\индикатор_фикс\комбинированный\fix_right_ind (vs human).csv"
