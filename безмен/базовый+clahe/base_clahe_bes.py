...
def save_needle_debug(debug_dir, frame_idx, debug_data):
    ...
    if not math.isnan(debug_data["angle"]):
        cv2.putText(crop_vis, f"угол={debug_data['angle']:.2f}", (8, 24), cv2.FONT_HERSHEY_SIMPLEX, 0.65, (0, 0, 255), 2, cv2.LINE_AA)
...
def main():
    p = argparse.ArgumentParser(
        description="Распознавание показаний безмена по видео (CLAHE)")
